import bgUrl from './team_page_bg.png';
    ...
    return (
        <div className="hero pt-20"
            ...
            <div className="p-10 text-center">
                ...
                <h1 className=" text-5xl text-white pt-12" style={{fontFamily: 'Cano'}}>Visuals</h1>
                <h3 className="text-white text-xl" style={{color: 'rgb(175,247,255)'}}>Art & Design Team</h3>
                {visualsTeam.map(function (value) {
                    return <MemberPhoto name={value.name} imgUrl={value.imgUrl}/>
                })}
                <h1 className=" text-5xl text-white pt-12" style={{fontFamily: 'Cano'}}>Professors</h1>
