import bgUrl from "./notebook_bg.png";
    ...
    return (
        <div className="hero pt-20"
            ...
            <div className="p-10 text-center">
                <h1 className=" text-8xl text-white pb-4" style={{fontFamily: 'Cano'}}>Notebook</h1>

                <div style={{display: 'flex', justifyContent: 'space-evenly'}} className="pt-2 pb-4">
                    <a className="btn btn-outline btn-info"> Download Calendar as PDF</a>
                    <a className="btn btn-outline btn-success"> Download Calendar as CSV</a>
                    <a className="btn btn-outline btn-secondary"> Download Calendar as HTMl</a>
                </div>
                {months.map(function (it) {
                    return (
                        <div>
                            <div className="block p-2 rounded-sm mt-4 mb-2"
                            ...
                            <div style={{display: 'flex', flexWrap: 'wrap'}}>
                                {
                                    it.data.map(function (data) {
                                        return <div
                                            className="card glass calendar-card relative inline-block content-center rounded-md m-4 p-2 z-10 backdrop-blur-lg from-[#fff2] to-[#fff1] bg-gradient-from-br bg-gradient-to-tl">
                                            <a className="block text-white text-sm text-start" style={{zIndex: 2}}>
                                                {data.text}
                                            </a>
                                            <div className="inline-block text-9xl absolute p-1 -z-10"
